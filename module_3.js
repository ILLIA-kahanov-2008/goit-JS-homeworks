...
// // 3-14
// // Выполни рефакторинг функции (task 3-12) countProps(object) используя метод Object.keys() и, возможно, цикл for...of.

// function countProps(object) {
//   // Change code below this line
//   const array = Object.keys(object);
//   let propCount = array.length;
...
// // !!!! пересмотреть более краткое решение !!!!
// const products = [
//   { name: 'Radar', price: 1300, quantity: 4 },
//   { name: 'Scanner', price: 2700, quantity: 3 },
//   { name: 'Droid', price: 400, quantity: 7 },
...
// console.log('sum :>> ', addOverNum(50, 15, 27));
// console.log('sum :>> ', addOverNum(10, 12, 4, 11, 48, 10, 8));
// console.log('sum :>> ', addOverNum(15, 32, 6, 13, 19, 8));
// console.log('sum :>> ', addOverNum(20, 74, 11, 62, 46, 12, 36));
...
// console.log('matches :>> ', findMatches([1, 2, 3, 4, 5], 1, 8, 2, 7));
// console.log('matches :>> ', findMatches([4, 89, 17, 36, 2], 8, 17, 89, 27, 2));
// console.log('matches :>> ', findMatches([10, 24, 41, 6, 9, 19], 24, 11, 9, 23, 41));
// console.log('matches :>> ', findMatches([63, 11, 8, 29], 4, 7, 16));
...
// // console.log(atTheOldToad.addPotion({ name: "Invisibility", price: 270 }));
// // console.log(atTheOldToad.addPotion({ name: "Dragon breath", price: 270 }));
// // в массиве potions последним элементом будет этот объект
