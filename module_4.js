...
//   let message = composeMessage.call(orders[i], i);
...
// console.log("1", firstInvoke);
// // Почта kiwi@mail.uk добавлена в рассылку.

// console.log("2", service.mailingList);
// /* ['mango@mail.com', 
//     'poly@hotmail.de', 
//     'ajax@jmail.net', 
//     'kiwi@mail.uk']*/
// const secondInvoke = logAndInvokeAction('poly@hotmail.de', service.unsubscribe.bind(service));
// console.log("3", secondInvoke);
// // Почта poly@hotmail.de удалена из рассылки.

// console.log("4", service.mailingList); // ['mango@mail.com', 'ajax@jmail.net', 'kiwi@mail.uk']
